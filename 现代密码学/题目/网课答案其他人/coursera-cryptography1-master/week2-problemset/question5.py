...
def main():
	...
	print("\n\n")
	print("c0=c1 xor c'0 ? => %s = %s xor %s => %s" %
	      (intToHexStr(c0), intToHexStr(c1), intToHexStr(c_0), (c1 ^ c_0 == c0)))
	print("c1=c0 ? => %s = %s  => %s" %
	      (intToHexStr(c1), intToHexStr(c0),  (c1 == c0)))
	print("c1=0^l ? => %s = %s  => %s" %
	      (intToHexStr(c1), intToHexStr(zero),  (c1 == zero)))
	print("c1=c'0 ? => %s = %s  => %s" %
	      (intToHexStr(c1), intToHexStr(c_0),  (c1 == c_0)))
