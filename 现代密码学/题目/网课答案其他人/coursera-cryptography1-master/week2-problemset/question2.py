...
def main():
    ...
    print("\n\nMore than an hour but less than a day? ",
          numberOfSeconds > hour and numberOfSeconds < day)
    print("More than a day but less than a week? ",
          numberOfSeconds > day and numberOfSeconds < week)
    print("More than a week but less than a month? ",
          numberOfSeconds > week and numberOfSeconds < month)
    print("More than a 100 years but less than a million years? ",
          numberOfSeconds > 100*year and numberOfSeconds < pow(10, 6)*year)
    print("More than a billion (10^9) years? ",
          numberOfSeconds > pow(10, 9)*year)
